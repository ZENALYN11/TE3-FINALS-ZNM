          ...
          <form action="function.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-2 mb-2">
              ...
              <div class="col-md-6 mb-3">
                <select class="form-select" name="province" id="Province<?php echo $row['id'] ?>">
                  <option value="" selected disabled><?php echo $row['province'] ?></option>
                </select>
              </div>
              <div class="col-md-6 mb-3">
                <select class="form-select" name="City" id="CityTown<?php echo $row['id'] ?>">
                  <option value="" selected disabled><?php echo $row['City'] ?></option>
                </select>
              </div>
              <div class="col-md-6 mb-3">
                <select class="form-select" name="barangay" id="Barangay<?php echo $row['id'] ?>">
                  <option value="" selected disabled><?php echo $row['barangay'] ?></option>
                </select>
              </div>
            </div>
            ...
            <div class="row g-2 mb-2">
              <div class="col">
                ...
                <input type="text" class="form-control" name="contactNo" maxlength="11" placeholder="" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required pattern="\d{11}" required value="<?php echo ($row['contactNo']); ?>">
              </div>
