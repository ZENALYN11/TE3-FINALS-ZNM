        ...
        <div class="container">
          <form action="function.php" method="POST">
            ...
            <div class="row g-2">
              ...
              <div class="col-md-6">
                <input type="text" class="form-control" value="<?php echo $resident['contactNo']?>" minlength="11" maxlength="11" name="contactNo" placeholder="Your Contact Number" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required pattern="\d{11}">
            ...
            <div class="row g-2">
              ...
              <div class="col-md-6">
                <input type="text" class="form-control" value="<?php echo $resident['motherContactNo']?>" minlength="11" maxlength="11" name="motherContactNo" placeholder="Your Mother's Contact Number" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
              ...
              <div class="col-md-6 mb-5">
                <input type="text" class="form-control" value="<?php echo $resident['fatherContactNo']?>" minlength="11" maxlength="11" name="fatherContactNo" placeholder="Your Father's Contact Number" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
